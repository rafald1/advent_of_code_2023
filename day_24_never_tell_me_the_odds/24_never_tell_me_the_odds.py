...
def check_if_hailstones_would_collide(hailstones, xy_min, xy_max):
    ...
    for hailstone_pair in hailstone_pairs:
        ...
        # x, y is point of collision
        # y = m_a * x + b_a and y = m_b * x + b_b -> m_a * x + b_a = m_b * x + b_b -> x = (b_b - b_a) / (m_a - m_b)
        x = (b_b - b_a) / (m_a - m_b)
        y = m_a * x + b_a
...
if __name__ == '__main__':
    ...
    # hailstones_data = read_data('../test_input/24.txt')
    # result = check_if_hailstones_will_collide(hailstones_data, 7, 27)
